...
public class Colors {
	public static final Color GREEN = new Color(0.3333333333333333f, 0.6588235294117647f, 0.40784313725490196f);
	public static final Color RED = new Color(196,78,82);
	public static final Color ORANGE = new Color(1.00f, 0.60f, 0.00f);
